...
class ResAttU_Net(nn.Module):
    def __init__(self,img_ch: int= 3, output_ch: int= 1, t: int= 2)-> None:
        ...
        self.Res1 = Residual_block(ch_in=img_ch,ch_out=64,t=t)

        self.Res2 = Residual_block(ch_in=64,ch_out=128,t=t)
        
        self.Res3 = Residual_block(ch_in=128,ch_out=256,t=t)
        
        self.Res4 = Residual_block(ch_in=256,ch_out=512,t=t)
        
        self.Res5 = Residual_block(ch_in=512,ch_out=1024,t=t)
        

        self.Up5 = up_conv(ch_in=1024,ch_out=512)
        self.Att5 = Attention_block(F_g=512,F_l=512,F_int=256)
        self.Up_Res5 = Residual_block(ch_in=1024, ch_out=512,t=t)
        
        self.Up4 = up_conv(ch_in=512,ch_out=256)
        self.Att4 = Attention_block(F_g=256,F_l=256,F_int=128)
        self.Up_Res4 = Residual_block(ch_in=512, ch_out=256,t=t)
        
        self.Up3 = up_conv(ch_in=256,ch_out=128)
        self.Att3 = Attention_block(F_g=128,F_l=128,F_int=64)
        self.Up_Res3 = Residual_block(ch_in=256, ch_out=128,t=t)
        
        self.Up2 = up_conv(ch_in=128,ch_out=64)
        self.Att2 = Attention_block(F_g=64,F_l=64,F_int=32)
        self.Up_Res2 = Residual_block(ch_in=128, ch_out=64,t=t)
