...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='/Users/manoskoutoulakis/Desktop/test_set/diceloss_AttUNet_7_4_multiclass_200_4_batch_2D')
    parser.add_argument('--test_path', type=str, default='/Users/manoskoutoulakis/Desktop/test_set/2test')
    parser.add_argument('--result_path', type=str, default='/Users/manoskoutoulakis/Desktop/test_set/2test')
