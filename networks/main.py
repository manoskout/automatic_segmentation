...
def main(config):
    ...
    if config.model_type not in ['U_Net_plus','SlaveAttU_Net','U_Net','DeepLabV3','DeepLabV3+','R2U_Net','AttU_Net','R2AttU_Net']:
    ...
    if config.model_type == "SlaveAttU_Net":
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type', type=str, default='U_Net', help='U_Net_plus/DeepLabV3/DeepLabV3+/U_Net/R2U_Net/AttU_Net/R2AttU_Net')
